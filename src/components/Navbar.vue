...
<template>
  <nav class="navbar bg-base-100 px-4">
    ...
    <div class="navbar-center">
      <h1 class="title text-xl md:text-2xl font-bold">GuessTheGame</h1>
    </div>
    <div class="navbar-end">
      <label class="swap swap-rotate">
        <input type="checkbox" class="theme-controller" @click="toggleTheme" />
        <svg
          class="swap-on h-6 w-6 md:h-8 md:w-8 fill-current"
        ...
        <svg
          class="swap-off h-6 w-6 md:h-8 md:w-8 fill-current"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24">
          <path
